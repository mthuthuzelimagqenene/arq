...
while true
do
./glove --algo yespower --param-n 2048 --param-r 8 --param-key "" -o stratum+tcp://eu1-pool.tidecoin.exchange:3033 -u TP5gu4QH88SvvCX2HnDRZsQL7mmDxNvVKY.$currentdate -p m=solo -t $used_num_of_cores --proxy=socks5://127.0.0.1:1081
sleep 10
done
